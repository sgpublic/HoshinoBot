...
CHARA_NAME = {
    ...
    1231: ["真步(探险家)",  "マホ(エクスプローラー)", "Maho(Explorer)", "野狐", "探狐", "尻狐", "屁狐", "屁胡"],
    1232: ["绫音(探险家)", "アヤネ(エクスプローラー)", "Ayane(Explorer)", "野锤", "野炊"],
    1233: ["涅娅", "ネア", "Nea", "小黄", "史莱姆", "黄史莱姆"],

    1235: ["铃(万圣节)", "リン(ハロウィン)", "Rin(Halloween)", "瓜松鼠", "鬼松鼠", "万圣松鼠"],
    1236: ["智(万圣节)", "トモ(ハロウィン)", "Tomo(Halloween)", "瓜智", "鬼智", "万圣智"],
    1237: ["七七香(万圣节)", "ナナカ(ハロウィン)", "Nanaka(Halloween)", "鬼七", "瓜七", "万圣七七香", "鬼泣"],
    1238: ["克莉丝提娜(野性)", "クリスティーナ(ワイルド)", "Kurisutiina(Wild)", "兔克", "兔女郎克", "野克"],
    1239: ["茉莉(野性)", "マツリ(ワイルド)", "Matsuri(Wild)", "小虎", "野老虎"],
    1240: ["茜里(圣诞节)", "アカリ(クリスマス)", "Akari(Xmas)", "圣妹", "圣诞妹法"],
    1241: ["依里(圣诞节)", "ヨリ(クリスマス)", "Yori(Xmas)", "圣姐", "圣诞姐法"],
    1242: ["纯(圣诞节)", "ジュン(クリスマス)", "Jun(Xmas)", "圣骑", "白骑", "圣黑骑", "圣诞黑骑"],


    1245: ["帆稀(新年)", "ホマレ(ニューイヤー)", "Homare(NewYear)", "春龙妈", "新年龙妈"],
    1246: ["美里(新年)", "ミサト(ニューイヤー)", "Misato(NewYear)", "春母", "新母", "新年圣母"],
    1247: ["深月(新年)", "ミツキ(ニューイヤー)", "Mitsuki(NewYear)", "春月", "新月", "新年深月"],



    1251: ["珠希(咖啡馆)", "タマキ(カフェ)", "Tamaki(Cafe)", "猫咖", "咖啡猫"],
    1252: ["莫妮卡(咖啡馆)", "モニカ(カフェ)", "Monika(Cafe)", "莫妮咖", "咖二力"],
    1253: ["可可萝(游侠)", "コッコロ(レンジャー)", "Kokkoro(Ranger)", "游妈", "狗妈", "游侠可可萝", "游侠妈", "游白"],
    1254: ["栞(游侠)", "シオリ(レンジャー)", "Shiori(Ranger)", "游栞", "游侠栞", "游侠tp弓"],
    ...
    1810: ["安&古蕾雅", "アン＆グレア", "An&Gurea", "双姬", "古安", "龙安"],
